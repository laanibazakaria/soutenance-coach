...
const ENTETES: ReadonlyArray<{ prefixe: string; exact?: boolean; entete: Entete }> = [
  ...
  { prefixe: "/app/m/pitch/simulation", entete: { section: "Pitch de projet", titre: "Simulation avec le jury d'innovation", sousTitre: "Il pose, tu réponds au micro, il te dit ce qui manque — et ce qu'il relancerait." } },
  ...
  { prefixe: "/app/m/concours/simulation", entete: { section: "Oral de concours", titre: "Simulation avec le jury d'admission", sousTitre: "Il pose, tu réponds au micro, il te dit ce qui manque — et ce qu'il relancerait." } },
