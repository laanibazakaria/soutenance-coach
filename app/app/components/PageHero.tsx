...
const ENTETES: ReadonlyArray<{ prefixe: string; exact?: boolean; centre?: boolean; entete: Entete }> = [
  ...
  { prefixe: "/app/jury", centre: true, entete: { section: "Entraînement", titre: "Simulation d'entretien", sousTitre: "Le jury pose une question, tu réponds à voix haute. Comme le jour J." } },
  { prefixe: "/app/entretien/simulation", centre: true, entete: { section: "Entretien d'embauche", titre: "Simulation avec le recruteur", sousTitre: "Il pose, tu réponds au micro, il te dit ce qui manque — et ce qu'il relancerait." } },
  ...
  { prefixe: "/app/m/pitch/simulation", centre: true, entete: { section: "Pitch de projet", titre: "Simulation avec le jury d'innovation", sousTitre: "Il pose, tu réponds au micro, il te dit ce qui manque — et ce qu'il relancerait." } },
  ...
  { prefixe: "/app/m/concours/simulation", centre: true, entete: { section: "Oral de concours", titre: "Simulation avec le jury d'admission", sousTitre: "Il pose, tu réponds au micro, il te dit ce qui manque — et ce qu'il relancerait." } },
  ...
  { prefixe: "/app/bilan", entete: { section: "Navigation", titre: "Mon bilan", sousTitre: "Une photographie de ta préparation — à imprimer, ou à partager avec ton encadrant." } },
