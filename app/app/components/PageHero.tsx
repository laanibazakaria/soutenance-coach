...
const ENTETES: ReadonlyArray<{ prefixe: string; exact?: boolean; centre?: boolean; entete: Entete }> = [
  ...
  { prefixe: "/app/appel", centre: true, entete: { section: "En direct", titre: "L'appel avec le jury", sousTitre: "Il parle, tu réponds au micro, il rebondit sur ce que tu viens de dire. Comme le jour J — avec le débrief en plus." } },
