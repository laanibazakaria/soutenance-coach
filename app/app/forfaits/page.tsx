      ...
      <div className="forfaits-grille">
        <article className="card forfait">
          ...
          <ul className="forfait-liste">
            ...
            <li>✓ Les quatre modules et leurs guides</li>
            <li>
        ...
        <article className="card forfait forfait-pro">
          ...
          <ul className="forfait-liste">
            ...
            <li>★ La <b>soutenance blanche</b> : exposé avec slides, jury qui enchaîne et relance, débrief complet</li>
            ...
            <li>★ <b>Bilan PDF</b> de progression, à garder ou à montrer à ton encadrant</li>
