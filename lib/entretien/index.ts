...
export const ETAPES_ENTRETIEN: readonly EtapeEntretien[] = [
  ...
  { id: "simulation", titre: "Simulation avec le recruteur IA", pourquoi: "Tu réponds au micro, il te dit ce qui manque et ce qu'il relancerait. Répondre dans sa tête ne compte pas.", action: "Lancer la simulation", lien: "/app/entretien/simulation" },
