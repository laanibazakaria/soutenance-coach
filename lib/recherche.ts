...
export const PAGES: ReadonlyArray<Page> = [
  ...
  { titre: "Simulation de jury", detail: "Le jury pose, tu réponds à voix haute", lien: "/app/jury", mots: "questions entretien soutenance" },
  ...
  { titre: "Simulation avec le recruteur", detail: "Il pose, tu réponds, il relance", lien: "/app/entretien/simulation", mots: "rh technique" },
