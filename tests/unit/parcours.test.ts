...
const vide: Contexte = { sessions: [], deckPresent: false, pitchGenere: false, questionsGenerees: false, avisCoach: false, fichesRevisees: false, blancheFaite: false, rapportDepose: false };
...
describe("persistance", () => {
  ...
  it("détecte le contexte depuis les clés du stockage", () => {
    ...
    expect(ctx).toEqual({ sessions: [], deckPresent: false, pitchGenere: true, questionsGenerees: true, avisCoach: true, fichesRevisees: false, blancheFaite: false, rapportDepose: false });
